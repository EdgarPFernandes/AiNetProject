...
class DisciplineController extends Controller
{
    ...
    // The index method version uses joins to filter by the teacher name
    ...
    // The index method version uses the method whereInntegerInRaw to filter
    public function index(Request $request): View
    {
        $filterByCourse = $request->query('course');
        $filterByYear = $request->year;
        ...
        if ($filterByName !== null) {
            $disciplinesQuery->where('name', 'LIKE', '%' . $filterByName . '%');
        }

        // Teacher Filtering - Alternative 1
        // The following code is commented out because it was replaced by alternative 2 for teacher filtering
        // if ($filterByTeacher !== null) {
        ...
        return view(
            'disciplines.index',
            compact('disciplines', 'filterByCourse', 'filterByYear', 'filterBySemester', 'filterByName', 'filterByTeacher')
        );
    }
